...
%>
	...
	<div class="row">
		<div class="span12">
			...
			Enter New Email :<input type="text" name="email" value="" class="span2 search-query"><br><br>
			<button type="submit" class="btn btn-warning">Change Email</button>&nbsp;<a href="Home.jsp"><button type="button" class="btn btn-inverse">GO BACK</button></a>  
			</form>
			</div>
